...
class StockSpider(scrapy.Spider):
    ...
    def start_requests(self):
        with open('/home/jbliu/projects/xueqiu_add/stockcode.txt','r',encoding='utf-8') as f:
            stocks=f.read()
    ...
    def parse_status(self,response):
        ...
        if statuses:
            ...
            with open('/home/jbliu/projects/xueqiu_add/pages.txt', 'r', encoding='utf-8') as f:
                x = f.read()
            y = eval(x)
            y[code] = page
            with open('/home/jbliu/projects/xueqiu_add/pages.txt', 'w', encoding='utf-8') as f:
                f.write(str(y))
        # else:
